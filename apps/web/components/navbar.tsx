    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-slate-950/75 py-3.5 backdrop-blur-md shadow-glass">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 sm:px-6">
        ...
        <Link href="/" className="group flex items-center gap-2.5">
          <div className="relative flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl border border-white/15 bg-white/5 transition-transform group-hover:scale-105">
            <img src="/logo.jpg" alt="Logo AgriVibe" className="h-full w-full object-cover" />
          </div>
          <span className="font-display text-sm font-bold tracking-wider text-white group-hover:text-agri-400 transition-colors">
